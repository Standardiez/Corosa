...
function initializeRideCreation() {
    ...
    if (!flowIntent) {
        console.warn('[Driver Create Ride] flowIntent not found, setting to driver');
    ...
    if (!pickupLocation || !dropoffLocation) {
        ...
        showError('Route information missing. Please select your pickup and destination locations.');
...
function setupFormValidation() {
    ...
    function validateForm() {
        ...
        if (hasDateTime && hasSeats) {
            ...
            console.log('[Driver Create Ride] Form incomplete, keeping submit button disabled');
        }
    }
...
function setupFormSubmission() {
    ...
    form.addEventListener('submit', async function(e) {
        ...
        const pickupCoords = sessionStorage.getItem('driverPickupCoordsForSubmit') || '';
        const dropoffCoords = sessionStorage.getItem('driverDropoffCoordsForSubmit') || '';
        ...
        try {
            ...
            if (result.status === 'success' || result.success) {
                console.log('[Driver Create Ride] Ride created successfully:', result.tripId || result.id);
