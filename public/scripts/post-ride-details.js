...
function renderPostRideDetails(ride) {
  const container = document.getElementById('postRideDetailsContainer');
  ...
  container.innerHTML = `
    ...
    <div class="border rounded-xl p-4 mb-6">
      <h3 class="font-semibold text-gray-700 mb-1">Your Rating</h3>
...
renderPostRideDetails(mockRide);
